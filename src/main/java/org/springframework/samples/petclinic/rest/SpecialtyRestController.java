...
public class SpecialtyRestController
{
    ...
    @Autowired
    public SpecialtyRestController(final ClinicService clinicService)
    {
    ...
    {
        final var specialties = List.copyOf(this.clinicService.findAllSpecialties());
    ...
    public ResponseEntity<Specialty> getSpecialty(@PathVariable("specialtyId") final int specialtyId)
    {
        final var specialty = this.clinicService.findSpecialtyById(specialtyId);
        if (specialty == null)
        {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
        }
            ...
            @RequestBody @Valid final Specialty specialty, final BindingResult bindingResult)
    {
        ...
        final var currentSpecialty = this.clinicService.findSpecialtyById(specialtyId);
    ...
    @Transactional
    public ResponseEntity<Void> deleteSpecialty(@PathVariable("specialtyId") final int specialtyId)
    {
        final var specialty = this.clinicService.findSpecialtyById(specialtyId);
        if (specialty == null)
        {
