...
public class JacksonCustomPetSerializer extends StdSerializer<Pet>
{
    ...
    protected JacksonCustomPetSerializer(final Class<Pet> t)
    {
        super(t);
    }

    @Override
    public void serialize(final Pet pet, final JsonGenerator jgen, final SerializerProvider provider) throws IOException
    {
