...
public class ClinicServiceImpl implements ClinicService
{
    ...
    @Override
    @Transactional(readOnly = true)
    public PetType findPetTypeById(final int petTypeId)
    {
    ...
    @Override
    @Transactional
    public void savePetType(final PetType petType) throws DataAccessException
    {
    ...
    @Override
    @Transactional
    public void deletePetType(final PetType petType) throws DataAccessException
    {
    ...
    @Override
    @Transactional
    public void saveSpecialty(final Specialty specialty) throws DataAccessException
    {
