...
public class ApplicationSwaggerConfig
{
    ...
    {
        return new ApiInfo("REST Petclinic backend Api Documentation",
                ...
                "1.0", "Petclinic backend terms of service",
                new Contact("Vitaliy Fedoriv", "https://github.com/spring-petclinic/spring-petclinic-rest",
